  ...
  <div class="main">
    <br><Alert>
      <Breadcrumb>
        ...
        <BreadcrumbItem to="results">成果</BreadcrumbItem>
      </Breadcrumb>
    </Alert>
      <Row>
        <Col span="6">
            <Menu  active-name="1-2" :open-names="['1']">
              <Submenu name="1">
                  ...
                  <div >
                      <div @click="loadData(7,'教学成果')">教学成果</div> 
                      <div @click="loadData(8,'论文')">论文</div> 
                      <div @click="loadData(9,'教材')">教材</div> 
                  </div>
              </Submenu>
          </Menu>
        </col>
