          ...
          <Row>
            ...
            <Col span="24">
              <FormItem label="上传图片："> 
                ...
                class="add-file-right-input" accept=".png,.jpg,.jpeg,.gif" id="upload-ele"><br>
...
export default {
      ...
      columns1: [
        ...
        { title: "图片", key: "title",
         render: (h, params) => {
            return h('img',  {
                attrs:{
                  src:'http://localhost:9090'+params.row.pic
                },
                style: {
                    height: '50px',
                }
  ...
  methods: {
    ...
    getFile(event) {
      ...
      .then(function(msg) {
        console.log(msg)
        thiz.formItem.pic = msg.data.data.src;
      });
    },
    //下一页上一页
    changepage(val) {
    ...
    remover(id) {
      ...
      this.$Modal.confirm({
        ...
        onOk: () => {
          ...
          thiz.$post("news/deleteNews", params)
            .then(function(msg) {
              console.log(msg);
