...
public class NoticeController {
	...
	private final NoticeService initService;

	public NoticeController(NoticeService initService) {
	...
	@ResponseBody
	public BaseModel add(Notice init ) {
	...
	@ResponseBody
	public BaseModel success(Notice init ) throws IllegalStateException, IOException {
		BaseModel baseModel = new BaseModel();
	...
	public BaseModel getById(int id) {
		BaseModel baseModel = new BaseModel();
		Notice init = initService.searchById(id);
		baseModel.setResultCode(200);
